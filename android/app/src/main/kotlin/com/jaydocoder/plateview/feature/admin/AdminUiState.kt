...
data class AdminUiState(
    ...
    val dashboardUserCount: Int = 0,
    val dashboardImportCount: Int = 0,
    val dashboardUpdatedAt: String? = null,
    val showSchedulePlanner: Boolean = false,
    val showWechatSync: Boolean = false,
    ...
    val isPrimaryAdministrator: Boolean = false,
