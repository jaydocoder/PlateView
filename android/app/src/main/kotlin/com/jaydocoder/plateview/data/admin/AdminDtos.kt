...
data class AdminVehicleListResponseDto(val items: List<AdminVehicleListItemDto>)
...
data class AdminImportBatchDto(val id: Long, val sourceFileName: String, val status: String, val stats: AdminImportBatchStatsDto, val createdAt: String?, val publishedAt: String?, val rollbackAt: String?, val rows: List<AdminImportRowDto>)
data class AdminImportBatchStatsDto(val totalRows: Int, val newRows: Int, val updateRows: Int, val duplicateRows: Int, val errorRows: Int, val warningRows: Int, val publishableRows: Int, val pendingReviewRows: Int)
