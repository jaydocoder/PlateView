...
data class AdminUserDto(val id: Long, val username: String, val role: String, val status: String, val version: Int, val createdAt: String?, val updatedAt: String?, val avatarVersion: Long, val hasAvatar: Boolean)
data class AdminUserCreateRequestDto(val username: String, val password: String, val role: String)
data class AdminUserUpdateRequestDto(val role: String, val status: String, val username: String? = null, val password: String? = null)
