...
当前正式版本为 `0.3.32`（`versionCode 36`）。Android 客户端最低支持 Android 12（API 31），采用 Kotlin 与 Jetpack Compose 开发；服务端采用 Kotlin、Ktor 与 PostgreSQL。
...
当前版本：`0.3.32`（`versionCode 36`）。最新正式 APK 可在 [GitHub Releases](https://github.com/jaydocoder/PlateView/releases) 下载。
